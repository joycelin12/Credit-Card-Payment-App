/*
  ...
  Date: 8/8/2020
  Purpose: The functions stored here are addValueToPassword to create the password
	to be checked against the local storage using getPassword. There is also on 
        click function for the disclaimer page
*/
...
/* 
 * On the main page, after password entry, directs user
 * to main page, legal disclaimer if they have not yet
 * agreed to it, or user entry page if they have not yet 
 * completed their user info. 
 */
